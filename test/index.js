...
mp3dat.stat(testFile, function(err,stats){
   ...
   stats.duration.should.have.keys('hours','minutes','seconds','miliseconds');
   
   //expected duration types and constraines
   ...
   stats.duration.miliseconds.should.be.below(1000).and.be.a.Number;
