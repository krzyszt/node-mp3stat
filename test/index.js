...
mp3dat.stat(testFile, function(err,stats){
   ...
   assert.notStrictEqual(stats.duration.miliseconds, undefined, 'should be a duration.miliseconds property');
   ...
   assert(!isNaN(stats.duration.miliseconds), 'duration.miliseconds should be a number');
   ...
   assert(stats.duration.miliseconds < 1000, 'duration.miliseconds should be no greater than 999');
